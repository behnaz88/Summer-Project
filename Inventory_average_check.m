function [ inventory_table, T2,machine1,state_matrix1,machine2,state_matrix2] = Inventory_average_check(run_duration,mu1,mu2,buffer_capacity)
    ...
    while( current_time < run_duration )
        ...
        deltaf;
        slope;
        behnaz = mat_inventory.value(i-1);
        baris = mat_inventory.value(i);
