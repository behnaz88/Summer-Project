function [f,Aeq, beq, sostype, sosind, soswt, lb, ub, ctype] = matrix_generator_b(run_duration, buffer_capacity, x0)

%Create Random States
[critical_time, slopes, cop, cop, cop, cop, cop, cop] = Input2(run_duration, 1.2, 1, buffer_capacity);
n = size(slopes, 2);
